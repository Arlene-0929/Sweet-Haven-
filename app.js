...
let products = [
  // Breads (3 products)
  { id: 1, name: 'Sourdough Loaf', price: 450, image: 'pics/sourdough.jpg', description: 'Traditional sourdough with a crispy crust and tangy flavor. Made with organic flour and natural starter.', category: 'Breads', rating: 4.8, reviewCount: 124, reviews: [], createdAt: Date.now() - 86400000 * 30, available: true },
  { id: 2, name: 'Baguette', price: 300, image: 'pics/baguette.jpg', description: 'Classic French baguette with a golden crust and soft interior. Perfect for sandwiches or dipping.', category: 'Breads', rating: 4.6, reviewCount: 156, reviews: [], createdAt: Date.now() - 86400000 * 25, available: true },
  { id: 3, name: 'Bagel', price: 380, image: 'pics/bagel.jpg', description: 'Healthy whole wheat bread packed with fiber and nutrients. Perfect for daily consumption.', category: 'Breads', rating: 4.5, reviewCount: 98, reviews: [], createdAt: Date.now() - 86400000 * 22, available: true },

  // Pastries (3 products)
  { id: 4, name: 'Croissant', price: 250, image: 'pics/croissant.jpg', description: 'Buttery, flaky French croissant. Baked fresh every morning with premium European butter.', category: 'Pastries', rating: 4.9, reviewCount: 203, reviews: [], createdAt: Date.now() - 86400000 * 20, available: true },
  { id: 5, name: 'Cinnamon roll', price: 350, image: 'pics/cinnamon roll.jpg', description: 'Light choux pastry filled with rich chocolate cream and topped with glossy chocolate glaze.', category: 'Pastries', rating: 4.9, reviewCount: 178, reviews: [], createdAt: Date.now() - 86400000 * 10, available: true },
  { id: 6, name: 'Chocolate Walnut tart', price: 280, image: 'pics/chocolate walnut tart.jpg', description: 'Flaky Danish pastry with sweet cream cheese filling and fruit topping.', category: 'Pastries', rating: 4.7, reviewCount: 145, reviews: [], createdAt: Date.now() - 86400000 * 15, available: true },

  // Cakes (3 products)
  { id: 7, name: 'Black forest cake', price: 200, image: 'pics/Black Forest cake.jpg', description: 'Moist vanilla cupcake topped with silky buttercream frosting. Perfect for any celebration.', category: 'Cakes', rating: 4.7, reviewCount: 89, reviews: [], createdAt: Date.now() - 86400000 * 15, available: true },
  { id: 8, name: 'Carrot cake', price: 280, image: 'pics/carrot cake slice.jpg', description: 'Rich and decadent chocolate cake with layers of chocolate ganache. A chocolate lover\'s dream.', category: 'Cakes', rating: 4.9, reviewCount: 167, reviews: [], createdAt: Date.now() - 86400000 * 11, available: true },
  { id: 9, name: 'Red Velvet cake', price: 220, image: 'pics/velvet cake.jpg', description: 'Classic red velvet cupcake with cream cheese frosting. Moist and flavorful.', category: 'Cakes', rating: 4.8, reviewCount: 142, reviews: [], createdAt: Date.now() - 86400000 * 9, available: true },

  // Cookies (3 products)
  { id: 10, name: 'Chocolate Chip Cookies', price: 180, image: 'pics/chocolate chip cookies.jpg', description: 'Classic chocolate chip cookies with gooey chocolate chunks. Soft and chewy.', category: 'Cookies', rating: 4.8, reviewCount: 234, reviews: [], createdAt: Date.now() - 86400000 * 6, available: true },
  { id: 11, name: 'Oatmeal Raisin Cookies', price: 160, image: 'pics/oatmeal raisin cookies.jpg', description: 'Wholesome oatmeal cookies with plump raisins. A healthy and delicious treat.', category: 'Cookies', rating: 4.5, reviewCount: 156, reviews: [], createdAt: Date.now() - 86400000 * 13, available: true },
  { id: 12, name: 'Swedish thumbprint Cookies', price: 190, image: 'pics/Swedish thumbprint cookies.jpg', description: 'Rich chocolate cookies with white and dark chocolate chips. For serious chocolate lovers.', category: 'Cookies', rating: 4.9, reviewCount: 189, reviews: [], createdAt: Date.now() - 86400000 * 4, available: true },

  // Gift Boxes (2 products)
  { id: 13, name: 'Gift Box Deluxe', price: 1800, image: 'pics/sourdough.jpg', description: 'Beautifully packaged assortment of our finest pastries and treats. Perfect for gifting.', category: 'Gift Boxes', rating: 5.0, reviewCount: 95, reviews: [], createdAt: Date.now() - 86400000 * 5, available: true },
  { id: 14, name: 'Gift Box Classic', price: 1200, image: 'pics/sourdough.jpg', description: 'Elegant gift box with a selection of our popular breads and pastries. Great for any occasion.', category: 'Gift Boxes', rating: 4.8, reviewCount: 78, reviews: [], createdAt: Date.now() - 86400000 * 2, available: true }
];
